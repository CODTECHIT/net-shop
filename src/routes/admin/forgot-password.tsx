...
function ForgotPasswordPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4 relative overflow-hidden">
      <SEO 
        title="Forgot Password | Vayus Networks Admin"
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          {isSuccess ? (
            <div className="text-center">
              <p className="text-green-400 mb-6">If the email exists, a reset link has been sent. Please check your inbox.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-sm text-gray-400 ml-1">Admin Email</label>
                <input
                  type="email"
                  value={email}
