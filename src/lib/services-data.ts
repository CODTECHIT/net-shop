import {
  IdCard, FileText, Home as HomeIcon, Building2, Zap, Car, Landmark,
  type LucideIcon,
} from "lucide-react";
...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  {
    ...
    services: [
      { name: "Ration Card", description: "Apply for or update your ration card for food subsidy benefits." },
      { name: "Aadhar Card", description: "New enrollment, corrections, and address updates for Aadhar." },
      { name: "PAN Card", description: "Apply for new PAN or make corrections to existing PAN card." },
      ...
      { name: "Passport of India", description: "Fresh passport application and renewal assistance." },
      { name: "Senior Citizen Card", description: "Registration and documentation for senior citizens." },
      { name: "UDID Card", description: "Unique Disability ID card for differently-abled citizens." },
    ],
  },
  {
    key: "certificates",
    ...
    services: [
      { name: "Birth & Death Certificate", description: "Official birth and death certificate issuance and corrections." },
      { name: "Family Member Certificate", description: "Certificate for family composition and relationships." },
      { name: "Marriage Certificate", description: "Legal marriage certificate application and registration." },
      { name: "Certificate of Possession", description: "Land or property possession certificate issuance." },
      { name: "No Earning Certificate", description: "Income/no earning certificate for government schemes." },
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Possession Certificate", description: "Legal certificate proving land/property possession." },
      { name: "Manual Adangal", description: "Manual land record requests and submissions." },
      { name: "Mutations of Passbook", description: "Land mutation for ownership transfer in passbooks." },
      { name: "Pattadar Adhar Seeding", description: "Link Aadhaar with Pattadar passbook for farmers." },
      { name: "Land Conversion", description: "Agricultural to non-agricultural land conversion." },
      { name: "Revenue Sub Division", description: "Revenue department sub-division related services." },
    ],
  },
  {
    key: "municipal",
  ...
  },
  {
    ...
    services: [
      { name: "Payments of Property, Tax and Water Tax", description: "Official government payments facilitated online." },
  ...
  },
  {
    ...
    services: [
      { name: "Slot Booking LLR", description: "Online slot booking for Learner's Licence Road test." },
      { name: "Driving Licence", description: "Transport department DL application and tracking." },
      { name: "Corrections and Address Change", description: "DL corrections and address update services." },
    ],
  },
  {
    key: "register",
    ...
    services: [
      { name: "Documents Registration", description: "Property and agreement document registration." },
      { name: "Market Value Certificate", description: "Official property market value certificate." },
      ...
      { name: "Firms Registration", description: "Partnership firm or proprietorship registration." },
      { name: "Hindu Marriage Certificate", description: "Certificate as per Hindu Marriage Act." },
      { name: "Special Marriage Registration", description: "Certificate under Special Marriage Act." },
      ...
      { name: "All Types of Insurance", description: "General and government insurance facilitation." },
    ],
  },
];
